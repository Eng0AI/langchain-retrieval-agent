  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          name="description"
          content="LangChain.js Retrieval Agent with Supabase vector store"
        />
        <meta property="og:title" content="LangChain Retrieval Agent" />
        <meta
        ...
        <meta name="twitter:title" content="LangChain Retrieval Agent" />
        <meta
